      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row mt-5">
          ...
          <div class="col-lg-8 mt-5 mt-lg-0">
           ...
           <form action="p_contact-save.php" method="post" role="form" class="mail-form">
              <div class="row">
					...
					<tr>
					<th></th>
					<div class="text-center"><button type="submit" style="height:30px;width:50x;">Add record</button></div>
					</tr>
			  </div>
            </form>
